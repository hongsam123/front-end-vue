...
<template>
  <div class="card">
    ...
    <div class="card-body">
      <!--데이터 바인딩-->
      <div>
        <img class="mr-2" v-bind:src="require(`@/assets/photos/photo1.jpg`)" height="100"/>
      ...
      <hr/>
      <button class="btn btn-sm btn-info mr-2" @click="changeData">변경</button>
...
export default {
  ...
  data: function() {
    return {
      ...
      sale : true,
      info : `<div style="background-color:#eeeeee">스타일 적용 하기</div>`,
    };
  },
  //컴포넌트 메소드 정의
  methods:{
