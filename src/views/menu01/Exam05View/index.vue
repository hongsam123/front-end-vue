...
<template>
  <div class="card">
    ...
    <div class="card-body">
      ...
      <h6>쿼리 스트링으로 전달</h6>
      <ul>
        <li><router-link to="/menu01/exam08view?kind=freeboard&color=blue">exam08view</router-link></li>
        <li><router-link :to="`/menu01/exam08view?kind=${kind1}&color=${color1}`">exam08view</router-link></li>
        <li><router-link :to="{path:`/menu01/exam08view?kind=${kind2}&color=${color2}`}">exam08view</router-link></li>
        <li><router-link :to="{name:'menu01_exam08view', query:{kind:kind3, color:color3}}">exam08view</router-link></li>
      </ul>
    </div>
  </div>
</template>
